...
framework machinery before the first business feature ships. Approach 1 is the only one
...
| --------------------------------------- | --------------------------------- | ------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------- | -------------------------------------------- | ------------------------------------------------------------------ |
| Effort to a usable v1                   | ~40 engineer-weeks                | ~16 ew for the 5 MVP plugins, on top of a working blueprint                                             | ~22 ew minimum credible v1; ~59 ew full                                      | ~30 ew                                       | ~40 ew by month 4; ~162 ew across the first year if all stages run |
